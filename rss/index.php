...
if ($artlist!==false){
	...
	foreach ($tracklist as $trackitem){
		...
		if (file_exists('./metadatacache/'.$trackitem.'.title.txt')&&
			...
			&&filesize('./metadatacache/'.$trackitem.'.title.txt')>0){
...
sleep(intval($sleeper));}
		...
		if (file_exists('./metadatacache/'.$trackitem.'.duration.txt')&&
			filemtime('./metadatacache/'.$trackitem.'.duration.txt')>$freshness
			&&filesize('./metadatacache/'.$trackitem.'.duration.txt')>0){
				$duration=file_get_contents('./metadatacache/'.$trackitem.'.duration.txt');
			}
...
sleep(intval($sleeper));}
		...
		if (file_exists('./metadatacache/'.$trackitem.'.artist.txt')&&
			...
			&&filesize('./metadatacache/'.$trackitem.'.artist.txt')>0){
...
sleep(intval($sleeper));}
		...
		if (file_exists('./metadatacache/'.$trackitem.'.pubdate.txt')&&
			filemtime('./metadatacache/'.$trackitem.'.pubdate.txt')>$freshness
			&&filesize('./metadatacache/'.$trackitem.'.pubdate.txt')>0){
				$pubdate=file_get_contents('./metadatacache/'.$trackitem.'.pubdate.txt');
			}
...
sleep(intval($sleeper));}
		...
		if (file_exists('./metadatacache/'.$trackitem.'.length.txt')&&
			filemtime('./metadatacache/'.$trackitem.'.length.txt')>$freshness
			&&filesize('./metadatacache/'.$trackitem.'.length.txt')>0){
				$length=file_get_contents('./metadatacache/'.$trackitem.'.length.txt');
			}
