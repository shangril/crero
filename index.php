...
</span><span style="float:right;text-align:right;"><?php if ($videoapiurl!==false){echo '<a href="./random_vids.php">Random videos</a> - <a href="./all_vids.php">Browse all videos</a>';} ?></span><br style="clear:both;"/>
